...
agent_name: $2 if provided, otherwise use 'e2e_runner'
e2e_test_file: $3
...
- Initialize Playwright browser in headless mode for visibility
...
- IMPORTANT: Make sure the app is running on a background process before executing the test steps. Read `README.md` for more information on how to start app
