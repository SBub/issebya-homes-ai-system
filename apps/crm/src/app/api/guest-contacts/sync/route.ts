 ...
 *
 * Postgres (finance_bookings) is the single source of truth: this just
 * re-derives guest_contacts (name/room/dates/total_stays) from it. No
 * external round trip involved.
 */
